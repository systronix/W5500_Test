/**
 * DHCP Stress Test for Arduino M0 Pro and WIZnet W5500 Ethernet Shield
 *
 ...
 *
 * Modified by Bruce Boyes to stress test DHCP client 
 * originally targeted at the WIZ820io and Teensy 3.X, using the PJRC Wiznet and SD card adapter 
 * as well as Systronix custom board codenamed SALT.
 *
 ...
 * Revisions
 *
 * 2016 Oct 28	bboyes	adapt to Arduino.org M0 Pro and WIZnet W5500 Shield
